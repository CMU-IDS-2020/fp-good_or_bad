...
We display the input preprocessing, training and predicting processes of one specific neural network architecture to help users understand sentiment analysis with machine learning. We referred to this [tutorial](https://github.com/bentrevett/pytorch-sentiment-analysis/blob/master/4%20-%20Convolutional%20Sentiment%20Analysis.ipynb) for the neural network model displayed in our application. Our model has the following architecture:
